...
\def \isubtitle {(Tuebingen Talk, June 2011---DRAFT)}
...
\begin{abstract}
Several researchers have conjectured that joint action partially explains how sophisticated* forms of cognition emerge in development or evolution \citep[for example, ][]{Knoblich:2006bn,Moll:2007gu}.  If any such conjecture is correct, what could joint action be?
...
* - yes, I do realise that the term `sophisticated' isn't very scientific; the talk will be more specific\end{abstract}
