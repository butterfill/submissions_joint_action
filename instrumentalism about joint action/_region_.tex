\message{ !name(joint action without shared intention.tex)}
...
\message{ !name(joint action without shared intention.tex) !offset(-3) }
...
\end{document}
\message{ !name(joint action without shared intention.tex) !offset(-239) }
